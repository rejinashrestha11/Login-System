"""
Django settings for acs_login project.
...
SECRET_KEY = 'django-insecure-g4q42zrt6+rc4dh0byah^t1ldql(2#4+6*&j2ym#fqlwc01gb2'
...
WSGI_APPLICATION = 'acs_login.wsgi.application'
